						...
						**/
							...
							if ($main_submit_permission) {
								...
								**/
								    ...
								    $msg = '为了保证发布信息的质量，所有信息需要经过审核后才能发布。如果您是注册会员，您可以在‘信息列表’中查看自己已经发布的信息。如果您是匿名用户，我们的编辑人员会在通过信息审核后，把信
												息的链接通过邮件发送给您。如果您希望查询审核进度，请加微信：646 963 1668, 或致电 1 (646) 963 1668';
										if ($user_id>0) {
												global $current_user;
											...
											/**
												...
												**/
													...
													<section class="pfsubmit-inner-sub">
								                        <label for="item_title" class="lbl-text">'.esc_html__('商家名称','pointfindert2d').':</label>
								                        <label class="lbl-ui">
