...
if(obj.customtabs==null||obj.customtabs==''||obj.customtabs=='undefined'){$('.customtab-output-container').hide();}else{$('.customtab-output-container').html(obj.customtabs);$('.customtab-output-container').show();}
