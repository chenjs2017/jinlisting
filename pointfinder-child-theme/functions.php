...
function get_location(){
    ...
    $Cities_of_Dallas=array('Addison',
'Balch Springs',
'Carrollton',
'Cedar Hill',
'Cockrell Hill',
...
'Wylie');
    ...
    $Cities_of_Atlanta=array('Acworth',
'Alpharetta',
'Atlanta',
'Auburn',
'Austell',
...
//$ip="192.227.139.106";//dallas
    ...
    if(isset($json['city'] ) && isset($json['region'] ) ) {
     ...
     return 'sf';
        ...
        if ((in_array($json['city'], $Cities_of_Dallas)) && ($json['region'] == 'TX')) {
            return 'dallas';
        }
        if ((in_array($json['city'], $Cities_of_Atlanta)) && ($json['region'] == 'GA')) {
            return 'atlanta';
        }
